...
itself, via the recent inductive proof of Fialho \cite{Fia20}. The
development is about 1250 lines of Lean, compiles against current
...
Theorems~\ref{thm:dob} and~\ref{thm:kp}. What remains open is the
convergent Ursell-series expansion of $\log Z$ itself, which requires
tree-graph bounds beyond the volume-linear control of
Theorem~\ref{thm:log}.
